...
export default {
  ...
  Info: 'Info',
  MongoDB: 'MongoDBName',
  'MongoDB TableName': 'Please enter mongodb table name',
  SqlTable: 'SqlTableName',
  'SqlTable TableName': 'Please enter SqlTable table name',
  ServeName: 'ServeName',
  'ServeName(required)': 'Please enter ServeName',
  AddField: 'Add field relationship',
  'sql(required)': 'Current SQL field (required)',
  'mdb(required)': 'Current db field (required)',
  'sqlfiled is empty': 'sqlfiled is empty',
  'sqlfiled is repeat': 'sqlfiled is repeat',
  'mdbfiled is empty': 'mdbfiled is empty',
