...
export default {
  ...
  'Table name is required': '请输入目标DB表名(必填)',
  ...
  Info: '提示',
  MongoDB: 'MongoDB表名',
  'MongoDB TableName': '请输入MongoDB表名',
  SqlTable: 'SqlTable表名',
  'SqlTable TableName': '请输入SqlTable表名',
  ServeName: '服务名称',
  'ServeName(required)': '请输入服务名称',
  AddField: '添加字段关系',
  'sql(required)': '当前sql字段(必填)',
  'mdb(required)': '对应db字段(必填)',
  'sqlfiled is empty': 'sql字段不能为空',
  'sqlfiled is repeat': 'sql字段有重复',
  'mdbfiled is empty': 'db字段不能为空',
